...
namespace Nemesys.Models.Interfaces
{
    ...
    {
        List<StarRecord> GetStarRecords();
        List<Report> GetStarredUserReports(int userId);
        List<User> GetUsersWhoStarredReport(int reportId);
        StarRecord StarReport(int userId, int reportId);
        bool IsStarred(int userId, int reportId);
        ...
        bool ChangeReportHazardType(int reportId, string hazardType);
